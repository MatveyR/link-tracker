...
public enum HumanMessages {
    HELLO(
        "Привет! Это бот для отслеживания обновлений на форумах. Введите \"/help\" для помощи"
    ),
    ERROR(
        "Я не умею на такое реагировать :(" + System.lineSeparator()
            + "Попробуйте ещё раз"
    ),
    HELP(
        "/start - Запуск бота" + System.lineSeparator()
    ...
    TRACK_LINK_ERROR(
        "Указана неверная ссылка :(" + System.lineSeparator()
            + "Убедитесь, что ссылка прикрепили ссылку в формате \"/track <ссылка>\" и что её формат верный"
    ),
    ENTER_LINK_TAGS(
        "При желании введите через пробел тэги для отслеживаемой ссылки" + System.lineSeparator()
            + "В противном случае нажмите \"Пропустить\""
    ),
    ENTER_LINK_FILTERS(
        "При желании введите фильтры для отслеживаемой ссылки" + System.lineSeparator()
            + "В противном случае нажмите \"Пропустить\""
    ),
